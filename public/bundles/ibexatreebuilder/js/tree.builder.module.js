...
export const InitiallySelectedItemsIdsContext = createContext();
                                                            ...
                                                            <CallbackContext.Provider value={callbackContextData}>
                                                                <DndProvider moveElement={moveElement}>
                                                                    <TreeContext.Provider value={tree}>
                                                                        <InitiallySelectedItemsIdsContext.Provider
                                                                            value={initiallySelectedItemsIds}
                                                                        >
                                                                            <LocalStorageExpandConnector
                                                                                initialValue={initiallyExpandedItemsIds}
                                                                            >
                                                                                <SelectedProvider>
                                                                                    <PortalProvider
                                                                                        portals={[
...
TreeBuilderModule.propTypes = {
    ...
    initiallyExpandedItemsIds: PropTypes.array,
};
