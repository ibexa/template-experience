(function(global, doc, ibexa) {
    ibexa.BlockConfigSelectFieldBase = class BlockConfigSelectFieldBase {
        constructor(config = {}) {
            this.selectorContainer = config.selectorContainer || '.ibexa-pb-block-select-field';
            this.selectorSourceInput = config.selectorSourceInput || 'select';
            this.selectorSelected = config.selectorSelected || '.ibexa-pb-block-select-field__selected';
            this.selectorSelectedItem = config.selectorSelectedItem || '.ibexa-pb-block-select-field__selected-item';
            this.selectorOptions = config.selectorOptions || '.ibexa-pb-block-select-field__options';
            this.selectorOptionsItem = config.selectorOptionsItem || '.ibexa-pb-block-select-field__options-item';
            this.classOptionSelected = config.classOptionSelected || 'ibexa-pb-block-select-field__options-item--selected';
            this.classSelectedRemove = config.classSelectedRemove || 'ibexa-pb-block-select-field__selected-remove';
            this.classOptionsHidden = config.classOptionsHidden || 'ibexa-pb-block-select-field__options--hidden';
