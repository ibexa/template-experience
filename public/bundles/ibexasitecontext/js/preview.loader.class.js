...
export default class PreviewLoader {
    constructor({ iframeWrapper, loaderWrapper, previewUrl, acceptableStatusGroups, iframeLoadCallback }) {
    ...
    init() {
        this.getPreviewStatus()
            ...
            .then((isAccepted) => {
                const iframeUrl = isAccepted ? this.previewUrl : window.Routing.generate('ibexa.site_context.no_preview_available');
