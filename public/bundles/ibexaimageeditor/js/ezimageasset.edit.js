(function (global, doc, ibexa, React, ReactDOM, Routing) {
    ...
    const openImageEditor = (event) => {
        ...
        const { languageCode } = event.currentTarget
            .closest('.ibexa-field-edit--ezimageasset') // eslint-disable-line prettier/prettier
            .querySelector('input[type="file"]').dataset;
