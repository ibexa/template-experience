Vue.component("specification", {
    template: `
    <div class="ibexa-field-edit__data ibexa-field-edit--with-preview ses_specification">

        <div class="ibexa-data-source">
            <input v-model="json_field" v-bind:id="id" v-bind:name="name" type="hidden" v-bind:value="value" class="ibexa-data-source__input form-control" />

            <div class="ibexa-field-edit-preview" style="display: block; margin-bottom: 10px; padding-bottom: 25px;"
                ...
                <button v-if="group.data == null || group.data.length == 0 || Object.keys(group.data).length === 0" type="button" style="margin-bottom: 10px;" class="btn ibexa-btn ibexa-btn--secondary"
                        @click="removeElement(spec_data, index_group)">{{ translate('button.remove_group') }}
                </button>
                <button v-if="group.data == null || group.data.length == 0 || Object.keys(group.data).length === 0" type="button" style="margin-bottom: 10px;" class="btn ibexa-btn ibexa-btn--primary ibexa-btn--no-text" @click="addSpec(index_group)">
                    <svg class="ibexa-icon ibexa-icon--small ibexa-icon--create">
                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/bundles/ibexaadminui/img/ibexa-icons.svg#create"></use>
                           </svg>
                </button> 
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm">
                                    <div class="ibexa-field-edit-preview__input-wrapper">
                                        <input placeholder="Specification" type="text" v-model="spec.label"
                                               class="ibexa-field-edit-preview__input form-control"/>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="ibexa-field-edit-preview__input-wrapper">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    class="ibexa-data-source__input form-control">
                                ...
                                <div class="col-sm">
                                    <button @click="removeElement(group.data, index);" type="button" class="btn ibexa-btn ibexa-btn--primary ibexa-btn--no-text">
                                        <svg class="ibexa-icon ibexa-icon--small">
                                            <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                 xlink:href="/bundles/ibexaadminui/img/ibexa-icons.svg#trash"></use>
                                        </svg>
                                    </button>
                                    <button @click="addSpec(index_group);" type="button" class="btn ibexa-btn ibexa-btn--primary ibexa-btn--no-text" >
                                       <svg class="ibexa-icon ibexa-icon--small">
                                            <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                            xlink:href="/bundles/ibexaadminui/img/ibexa-icons.svg#create"></use>
                                       </svg>
                                    </button>
                                </div>
                            </div>
      ...
      <span v-for="group in not_used_groups">
          <button type="button" class="btn ibexa-btn ibexa-btn--primary ibexa-btn--no-text" @click="addGroup(group)">
              <svg class="ibexa-icon ibexa-icon--small ibexa-icon--create">
                  <use xmlns:xlink="http://www.w3.org/1999/xlink"
                       xlink:href="/bundles/ibexaadminui/img/ibexa-icons.svg#create"></use>
              </svg>
