(function(global, doc, ibexa, React, ReactDOM, Translator) {
    ...
    const openFormBuilder = (event) => {
        ...
        const config = { ...ibexa.formBuilder.config, fieldValue,
        ...
        global.parent.document.body.dispatchEvent(new CustomEvent('ibexa-udw-hide-footer'));
        ...
        formBuilder = ReactDOM.render(React.createElement(ibexa.modules.FormBuilder, config), formBuilderContainer);
    };
