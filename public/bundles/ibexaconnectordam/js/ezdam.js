...
(function(global, doc, Translator, bootstrap, eZ, Routing) {
    const DOTS = '...';
    const PAGE_LIMIT = 20;
    ...
    class EzDamExtension {
        ...
        refreshPagination(results) {
            ...
            const { template } = paginationElement.dataset;
...
})(window, window.document, window.Translator, window.bootstrap, window.eZ, window.Routing);
