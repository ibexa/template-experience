(function(global, doc, eZ, Translator) {
    ...
    const toggleGroupItemsSelect = (event) => {
        ...
        groupContent.querySelectorAll('.ez-page-select-items__items-list .ibexa-input--checkbox').forEach((itemCheckbox) => {
    ...
    const updateGroupHeader = (container) => {
        container.querySelectorAll('.ez-page-select-items__select-all-items').forEach((selectAllItemsCheckbox) => {
            const group = selectAllItemsCheckbox.closest('.ez-page-select-items__group-content');
            ...
            const isAnyBlockUnchecked = [...group.querySelectorAll('.ez-page-select-items__items-list .ibexa-input--checkbox')].some(
    ...
    doc.querySelectorAll('.ez-page-select-items__item .ibexa-input--checkbox').forEach((itemCheckbox) => {
