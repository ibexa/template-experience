    ...
    export default {
        ...
        methods: {
            showDashboardOverview() {
                var vm = this;
                axios.post('http://localhost:8000/api/ibexa/v2/rest/dashboard-overview',
                        {
                            "get_overview_data": [
                                {
                                    "type": "dashboard",
            ...
            showDashboardSalesCharts() {
                ...
                axios.post('http://localhost:8000/api/ibexa/v2/rest/dashboard-charts',
                        {
                            "get_chart_data": [
                                {
                                    "range": [
            ...
            showDashboardBestseller() {
                var vm = this;
                axios.post('http://localhost:8000/api/ibexa/v2/rest/dashboard-bestserller',
                        {
                            "get_panel_data":
                                [
                                    {
            ...
            showDashboardSearchTerms() {
                var vm = this;
                axios.post('http://localhost:8000/api/ibexa/v2/rest/dashboard-searchterms',
                        {
                            "get_tab_data":
                                [
                                    {
