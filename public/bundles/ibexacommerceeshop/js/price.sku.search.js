...
(function(global, doc, ibexa) {
    const skuWrapper = doc.querySelector('.ibexa-sku-search--price');
    ...
    const tableWrapper = skuWrapper.querySelector('.ibexa-price-management');
    ...
    const search = (skuCode, currency = 'EUR') => {
        ...
        const request = new Request(Routing.generate('ibexa.commerce.menu.admin.fetch_prices', { shopId: 'MAIN', currency }), {
            method: 'POST',
    ...
    const save = () => {
        ...
        const request = new Request(Routing.generate('ibexa.commerce.menu.admin.update_prices'), {
            method: 'POST',
