(function (global, doc) {
    ...
    const updateUnitLabels = ({ currentTarget }) => {
        const container = getContainer(currentTarget);
        const unit = currentTarget.querySelector(`[value="${currentTarget.value}"]`).innerHTML;
    ...
    const addEventsListeners = (container) => {
        ...
        const defaultValueInput = container.querySelector('.ibexa-measurement-default-value--simple .ibexa-input');
