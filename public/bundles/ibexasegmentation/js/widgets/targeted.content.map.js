(function (global, doc, ibexa, Translator) {
    ...
    const openUdw = (itemsContainer, draggable, event) => {
        ...
        const title = Translator.trans(/*@Desc("Select content")*/ 'config_form.widgets.segmentation.udw.title', {}, 'ibexa_page_builder');
    ...
    const updateTagNode = (locations, itemsContainer, contentInfoTagNode, contentItemName) => {
    ...
    const selectContent = (itemsContainer, openUdwButton, items) => {
        ...
        const locationIds = removeRootFromPathString(selectedContent.pathString);
        ...
        if (locationIds.length) {
            findLocationsByIdList(locationIds, (locations) =>
                updateTagNode(locations, itemsContainer, contentInfoTagNode, contentItemName),
            );
        } else {
