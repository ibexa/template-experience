(function(global, doc) {
    ...
    const toggleDeleteButtonDisabledState = () => {
        ...
        const deleteButton = doc.querySelector('.ibexa-btn--delete-public-access');
    ...
    const createPublicAccess = () => {
        ...
        doc.body.dispatchEvent(
            new CustomEvent('ez-initialize-card-toggle-group', {
                detail: { button: htmlWidget.querySelector('.ibexa-card__body-display-toggler') },
            }),
        );
        doc.body.dispatchEvent(
    ...
    const attachEventToCreateButton = () => {
        const createButton = doc.querySelector('.ibexa-btn--create-public-access');
