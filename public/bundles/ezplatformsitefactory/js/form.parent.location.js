(function(global, doc, eZ, React, ReactDOM, Translator) {
    ...
    const parentLocationBreadcrumbsNode = doc.querySelector('.ez-site-factory-parent-location__breadcrumbs');
    const parentLocationBreadcrumbsContentNode = doc.querySelector('.ez-site-factory-parent-location__breadcrumbs-content');
    ...
    const onConfirm = (items) => {
        ...
        findLocationsByIdList(removeRootFromPathString(pathString), (data) => {
            parentLocationBreadcrumbsContentNode.innerHTML = buildBreadcrumbsString(data);
        });
    ...
    const clearParentLocation = () => {
        parentLocationBreadcrumbsContentNode.innerHTML = '';
    ...
    const toggleVisibility = () => {
        ...
        if (value) {
            ...
            parentLocationBreadcrumbsNode.removeAttribute('hidden');
        } else {
            openUdwBtn.removeAttribute('hidden');
            parentLocationBreadcrumbsNode.setAttribute('hidden', true);
        }
    };
    const changeParentLocationIdByDesign = (event) => {
        ...
        parentLocationBreadcrumbsContentNode.innerHTML = parentLocationBreadcrumbs || '';
