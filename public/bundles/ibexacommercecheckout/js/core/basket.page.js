...
(function(global, doc) {
    class BasketPage {
        ...
        bindRemoveEvents() {
            this.container
                .querySelectorAll('.ibexa-commerce-js--remove-product')
                .forEach((button) => button.addEventListener('click', this.removeProduct.bind(this), false));
        }

        bindUpdateEvent() {
            const updateButton = this.container.querySelector('.ibexa-commerce-js--update-basket');
        ...
        bindChangeQuantityEvent() {
            this.container
                .querySelectorAll('.ibexa-commerce-js--quantity')
