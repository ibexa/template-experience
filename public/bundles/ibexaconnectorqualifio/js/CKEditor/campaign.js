    ...
    const updateCampaignList = (dropdown) => {
        ...
        fetch(request)
            ...
            .catch(() => {
                ...
                const message = Translator.trans(/*@Desc("Invalid response from API.")*/ 'campaign.get_list.alert.title', {}, 'ck_editor');

                campaignDropdowns.forEach((campaignDropdown) => campaignDropdown.showWarning(message));
            });
    };
