(function(global, doc, ibexa, bootstrap, flatpickr) {
    const SELECTOR_MODAL_RESCHEDULE = '#reschedule-future-hide-modal';
    ...
    const btnClear = doc.querySelector('.ibexa-reschedule-future-hide-modal__clear-input');
...
})(window, window.document, window.ibexa, window.bootstrap, window.flatpickr);
