(function(global, doc, eZ, bootstrap, flatpickr) {
    ...
    const btnClear = doc.querySelector('.ez-reschedule-future-hide-modal__clear-input');
...
})(window, window.document, window.eZ, window.bootstrap, window.flatpickr);
