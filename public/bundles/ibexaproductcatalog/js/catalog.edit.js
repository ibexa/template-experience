...
(function (global, doc, ibexa, Translator, Routing) {
    ...
    const toggleFilterList = ({ currentTarget }) => {
        const showLabel = Translator.trans(/*@Desc("Show")*/ 'catalog.edit.filters.toggler.show', {}, 'ibexa_product_catalog');
        const hideLabel = Translator.trans(/*@Desc("Hide")*/ 'catalog.edit.filters.toggler.hide', {}, 'ibexa_product_catalog');
    ...
    const buildRefreshProductsListRequestBody = () => {
    ...
    const refreshProductsList = () => {
        const requestBody = buildRefreshProductsListRequestBody();
