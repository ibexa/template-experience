...
class TimeRangeFilterConfig extends BaseFilterConfig {
    constructor(config) {
        super(config);

        this.sourceMinInput = this.configPanelNode.querySelector(
            '.ibexa-pc-edit-config-timerange-filter__field--min .ibexa-picker__form-input',
        );
        this.sourceMaxInput = this.configPanelNode.querySelector(
            '.ibexa-pc-edit-config-timerange-filter__field--max .ibexa-picker__form-input',
        );
    ...
    initDatePicker(input) {
        const container = input.closest('.ibexa-pc-edit-config-timerange-filter__field');
        let defaultDate;
...
export default TimeRangeFilterConfig;
