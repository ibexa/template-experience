(function (global, doc, ibexa, bootstrap, React, ReactDOM, Translator, Routing) {
    ...
    let createCollectionModalSubtitleNode;
    const initCollectionModal = () => {
        ...
        createCollectionModalSubtitleNode = createCollectionModalNode.querySelector(
    ...
    const insertValidationStatusListItem = (asset) => {
        ...
        const msg =
            asset.error ??
            Translator.trans(/*@Desc("100% Uploaded")*/ 'product.view.assets.validation_status_modal.success', {}, 'ibexa_product_catalog');
    ...
    const addAssetsByUDW = ({ currentTarget }) => {
        ...
        const title = Translator.trans(/*@Desc("Select Image Asset")*/ 'ezimageasset.title', {}, 'ibexa_product_catalog');
    ...
    const toggleAssetChecked = ({ currentTarget }) => {
        ...
        createCollectionModalSubtitleNode.innerHTML = Translator.trans(
            /*@Desc("Selected images: %count%")*/ 'product.view.assets.create_collection.sub_title',
