...
(function(global, doc) {
    class Product {
        ...
        fetchStoredBasketsList() {
            ...
            fetch(request)
                ...
                .then((response) => {
                    ...
                    this.addStoredBasketButton.classList.add('ezcommerce-product__basket-button--expanded');
        ...
        showStoredBasketMessage({ message, type }) {
            ...
            this.storedBasketMessageNode.classList.add(`ezcommerce-product__stored-baskets-messages--${type}`);
            this.storedBasketMessageTimeout = setTimeout(() => {
                this.storedBasketMessageNode.innerHTML = '';
                this.storedBasketMessageNode.classList = ['ezcommerce-product__stored-baskets-messages'];
            }, this.messageDelay);
        }
