...
(function(doc, getComputedStyle, eZ, Routing, Translator) {
    ...
    const onConfirmContexItems = (button, items) => {
        ...
        items.forEach((item) => {
            ...
            const useContentRemoteId = container.dataset.useContentRemoteId
            const contentId = useContentRemoteId ? item.ContentInfo.Content._remoteId : item.ContentInfo.Content._id;
