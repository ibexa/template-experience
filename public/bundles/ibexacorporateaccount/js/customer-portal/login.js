(function (global, doc) {
    ...
    const loginBtn = doc.querySelector('.ibexa-ca-login__btn--sign-in');
    const nameInput = doc.querySelector('.ibexa-ca-login__input--name');
    const passwordInput = doc.querySelector('.ibexa-ca-login__input--password');
