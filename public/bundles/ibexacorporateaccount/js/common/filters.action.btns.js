(function (global, doc, ibexa) {
    console.warn('[DEPRECATED] corporate-account/src/bundle/Resources/public/js/common/filters.action.btns.js script is deprecated');
    console.warn('[DEPRECATED] it will be removed from ibexa/corporate-account in 5.0');
    console.warn('[DEPRECATED] please use admin-ui/src/bundle/Resources/public/js/scripts/filters.action.btns.js instead');
