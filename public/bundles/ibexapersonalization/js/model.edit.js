(function(doc, Routing, ibexa) {
    ...
    const addItemByClick = (event) => {
        ...
        const activeSubmodelSelectedContainer = draggedItem
            ...
            .querySelector('.ibexa-perso-submodel-group.ibexa-perso-submodel-group--active');
    ...
    const dropItem = (event) => {
        ...
        const activeGroup = groupsWrapper.querySelector('.ibexa-perso-submodel-group--active');

        if (!isFromSidebar) {
            draggedItem.parentNode.removeChild(draggedItem);
        }

        activeGroup?.classList.remove('ibexa-perso-submodel-group--active');
        groupItemsContainer.classList.add('ibexa-perso-submodel-group--active');
...
})(window.document, window.Routing, window.ibexa);
