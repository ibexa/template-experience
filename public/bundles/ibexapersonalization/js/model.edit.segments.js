(function (doc) {
    ...
    const toggleEmptyContainer = () => {
        const sidebarItemsContainer = sidebar.querySelector('.ibexa-perso-segment-sidebar__list');
        const sidebarItemsEmpty = sidebar.querySelector('.ibexa-perso-segment-sidebar__list-empty');
        const items = sidebarItemsContainer.querySelectorAll(`.ibexa-perso-segment-sidebar-item`);
    ...
    const attachSidebarItemEvents = (item) => {
        const contentContainer = item.querySelector('.ibexa-perso-segment-sidebar-item__content');

        contentContainer.addEventListener('dragstart', dragStart.bind(null, '.ibexa-perso-segment-sidebar-item'), false);
    ...
    const attachGroupEvents = (group) => {
        ...
        group.addEventListener('dragstart', dragStart.bind(null, '.ibexa-perso-segment-group-item'), false);
    ...
    const addSidebarItem = (value, isActive) => {
        ...
        const contentContainer = insertedItem.querySelector('.ibexa-perso-segment-sidebar-item__content');

        contentContainer.draggable = isActive;
    ...
    const addItemByClick = (event) => {
        draggedItem = event.currentTarget.closest('.ibexa-perso-segment-sidebar-item');
    ...
    const removeGroupItem = (event) => {
        ...
        groupItem.closest('.form-group').remove();
