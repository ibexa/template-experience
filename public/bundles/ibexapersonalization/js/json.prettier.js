const CLASS_JSON_KEY = 'ibexa-json ibexa-json__key';
const CLASS_JSON_VALUE = 'ibexa-json ibexa-json__value';
const CLASS_JSON_STRING = 'ibexa-json ibexa-json__string';
const REGEXP_JSON_LINE = /^( *)("[\w]+": )?("[^"]*"|[\w.+-]*)?([,[{])?$/gm;
