...
(function(doc, ibexa, bootstrap) {
    ...
    const dataTypeDropdownsContainers = doc.querySelectorAll('.ibexa-perso-strategy-model__select-submodels-container .ibexa-dropdown--custom-init');
    const contextDropdownsContainers = doc.querySelectorAll('.ibexa-perso-strategy-model__select-context-container .ibexa-dropdown--custom-init');
    ...
    const adjustDataTypeDropdownSelection = (dropdownContainer, allowedValues, optionToSelect = null) => {
    ...
    prerenderedStrategyModels.forEach((strategyContainer) => {
        ...
        adjustDataTypeDropdownSelection(dataTypeDropdownContainer, dataTypeAllowedValues);
        adjustDataTypeDropdownVisibility(dataTypeDropdownContainer, dataTypeAllowedValues);
    });
